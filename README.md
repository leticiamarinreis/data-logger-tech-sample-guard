...
- **C++ (Arduino Framework):** Linguagem principal utilizada para o desenvolvimento do firmware, controle de periféricos, lógica de processamento e gerenciamento da EEPROM.
